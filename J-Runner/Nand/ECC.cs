...
namespace JRunner
{
    public class ECC
    {
        ...
        public int creatergh2ecc(string filename, string outputfolder, ref ProgressBar pb)
        {
            return creatergh2ecc(filename, outputfolder, ref pb, "");
        }
                ...
                for (block = 0; block < 30; block++)
                {
                    ...
                    if (id == 2)
                    {
                        if (semi == 0)
                        {
                            ...
                            {
                                if (variables.debugme) Console.WriteLine("This CB version can be for a Falcon or an Opus");
                                dt.CB_A = data;
                            }
                            else dt.CB_A = data;
                            semi = 1;
