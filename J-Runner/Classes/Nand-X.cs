        ...
        private Errors xsvfwrite(string filename, UsbDevice MyUsbDevice)
        {
            lock (MainForm._object)
            {
                try
                {
                    ...
                    Console.WriteLine("Flashing {0} to CoolRunner", filename);
        ...
        public Errors xsvf(string filename)
        {
            ...
            try
            {
                ...
                if (sendXSVF(x64_id, MyUsbDevice, writer) == 1)
                {
                    ...
                    Console.WriteLine("Xilinx XC2C64A-VQ44 ......... [DETECTED]");
                ...
                {
                    Console.WriteLine("Xilinx XC2C32A-VQ44 ......... [DETECTED]");
                ...
                {
                    Console.WriteLine("Xilinx XC2C128-VQ100 ......... [DETECTED]");
                ...
                {
                    Console.WriteLine("Xilinx XC2C256-VQ100 ......... [DETECTED]");
